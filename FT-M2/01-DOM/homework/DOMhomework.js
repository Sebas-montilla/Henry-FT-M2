...
// Tu código acá:
let name = "Sebastian Montilla"; //* Define the name
let span = document.querySelector("#createdBy"); //* Get the span in my document
span.innerHTML = span.innerHTML + " " + name; //* Set it up
...
function displayToDos() {
  ...
  // 4
  result.map((a) => toDoContainer.appendChild(a));
}
